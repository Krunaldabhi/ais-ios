...
class MakeJson {
    ...
    class func SingUp(firstName : String, lastName: String, email: String, mobile: Int, password: String, ConfirmPassword: String,device_Id: String, device_type: String, device_token: String,referral_code:String,service_type:String,service_number:String,service_model:String,country_code:String,fleet_id:String) -> UserData {
