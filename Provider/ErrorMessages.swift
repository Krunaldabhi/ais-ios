...
struct ErrorMessage {
    ...
    let enterServiceType = "Choose service type"
    let enterOwenrType = "Choose Limo Owner type"
    let enterVehicleCode = "Enter vehicle code"
    let enterModel = "Enter vehicle model"
    
    let enterDestination = "Enter Destination"
